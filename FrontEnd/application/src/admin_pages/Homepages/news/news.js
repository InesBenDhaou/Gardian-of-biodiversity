...
import Actus from '../../../pages/news/Actus';
import AddAdmin from './addnews';
...
function Newsadmin() {
    ...
    return (
        <>
            ...
            {componentToShow === 'show' && <Actus />}
            {componentToShow === 'update' && <UpdateNews />}
            {componentToShow === 'delete' && <DeleteNews/>}
