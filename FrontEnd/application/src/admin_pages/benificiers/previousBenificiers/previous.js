...
import Previous from '../../../pages/benificiers/previousBenificier/Previous';
import AddPrevious from './addprevious';
import UpdatePrevious from './updateprevious';
import DeletePrevious from './deleteprevious';
...
function PreviousAdmin() {
    ...
    return (
        <>
            {componentToShow === 'add' && <AddPrevious />}
            {componentToShow === 'show' && <Previous />}
            {componentToShow === 'update' && <UpdatePrevious />}
            {componentToShow === 'delete' && <DeletePrevious/> }

            {!componentToShow && (
                <div  className='section_news_admin'>
                    <h1 className='section__news__title'>PREVIOUS BENIFICIERS SECTION</h1>
                    <div className="main">
                        <div className="up">
